...
mod tests {
    use super::*;
    use crate::forest::indirect::enum_chunk;
    use crate::forest::nav::{Nav, WithParent};
    use crate::forest::node_id::HasId;
    use crate::forest::tree::NodeNav;
    ...
    fn print_sizes() {
        println!(
            "UniformChunk:{} IndirectChunk:{} EnumChunk:{}, ahash ImMap:{}, Default ImMap:{}, stdMap:{}",
