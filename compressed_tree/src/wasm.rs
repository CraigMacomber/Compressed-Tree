...
use crate::{
    basic_tree::{BasicFields, BasicNodes, BasicNodesCursor, BasicFieldsCursor, from_root},
    EitherCursor, FieldsCursor, NodesCursor, FieldKey, forest::example_node::BasicNode, TreeType,
};
...
impl WasmCursor {
    ...
    pub fn new() -> Self {
        ...
        WasmCursor {
            tree,
            cursor: todo!()//Cursor::Nodes(from_root(tree))
        }
    }
